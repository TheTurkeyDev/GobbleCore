...
public class EntityLoader
{
	...
	{
		EntityRegistry.registerModEntity(entityClass, name, id++, subMod, trackingRange, updateFrequency, sendsVelocityUpdates);
	}
	...
	{
		EntityRegistry.registerModEntity(entityClass, name, id++, subMod, trackingRange, updateFrequency, sendsVelocityUpdates, eggPrimary, eggSecondary);
	}
